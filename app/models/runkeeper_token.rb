class RunkeeperToken < Oauth2Token
  ...
  #def populate_meta
  #  meta_data = RunkeeperMeta.find_or_initialize_by_consumer_token_id(id)
  ...
  #has_one :meta, class_name: 'RunkeeperMeta', foreign_key: :consumer_token_id, inverse_of: :runkeeper_token
